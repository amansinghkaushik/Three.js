...
const Developer = ({ animationName = 'idle', ...props }) => {
  ...
  useEffect(() => {
    // Capture the current action to avoid closure issues
    const currentAction = actions?.[animationName];
    
    // Safety check - if action doesn't exist, do nothing
    if (!currentAction) {
      return;
    }
    ...
    // Cleanup function - fade out the current animation when it changes or component unmounts
    return () => {
      if (currentAction) {
